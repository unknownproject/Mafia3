  ...
  BEGIN 
    ...
    TRY 
      TRY 
        ...
        CalcCRC32 (Stream.Memory, Stream.Size-4, CRCvalue) //fixed for mafia 3
      EXCEPT 
        ON E: EReadError DO 
         error := 1 
      END; 
...
{          IF   (error = 0) AND (BytesRead > 0)
          THEN BEGIN
            ...
            CalcCRC32 (IOBuffer, BytesRead-4, CRCvalue); // fixed for mafia3 savegames
            //TotalBytes := TotalBytes + BytesRead;
            TotalBytes := TotalBytes + BytesRead-4;
          END
